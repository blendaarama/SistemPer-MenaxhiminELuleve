...
const CartPageComponent = () => {
  ...
  return (
    <div style={{ padding: "40px 6%", maxWidth: "900px", margin: "40px auto", backgroundColor: "#FFFFFF", border: "1px solid #E6E0D8", fontFamily: "system-ui, sans-serif", borderRadius: "8px" }}>
      <h2 style={{ fontFamily: "Georgia, serif", color: "#2B1A4A", marginBottom: "30px" }}>
      ...
      {cartItems.length === 0 ? (
        <div style={{ textAlign: "center", padding: "40px 0" }}>
          ...
          <Link
            to="/"
            style={{ display: "inline-block", marginTop: "15px", background: "#2B1A4A", color: "white", padding: "10px 20px", textDecoration: "none", fontSize: "14px", fontWeight: "600", borderRadius: "4px" }}
          >
            Kthehu te Dyqani
          </Link>
        </div>
        ...
        <div>
            ...
            <div key={item.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 0", borderBottom: "1px solid #E6E0D8" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
                <img
                  ...
                  style={{ width: "80px", height: "80px", objectFit: "cover", border: "1px solid #E6E0D8", borderRadius: "4px" }}
                  onError={e => { e.target.src = "https://images.unsplash.com/photo-1490750967868-88df5691cc51?w=200"; }}
                />
                <div>
                  <h4 style={{ margin: "0 0 5px 0", color: "#110D1A", fontSize: "16px" }}>
          ...
          <div style={{ marginTop: "30px", textAlign: "right" }}>
            <h3 style={{ fontFamily: "Georgia, serif", color: "#2B1A4A", marginBottom: "20px" }}>
              Totali: ${total.toFixed(2)}
            </h3>
            <button
              onClick={clearCart}
              style={{ background: "transparent", color: "#777", border: "1px solid #777", padding: "10px 20px", marginRight: "15px", cursor: "pointer", fontSize: "12px", fontWeight: "600", textTransform: "uppercase", borderRadius: "4px" }}
            >
              Pastro Shportën
            </button>
            <button
              onClick={() => setShowCheckoutModal(true)}
              style={{ background: "#2B1A4A", color: "white", border: "none", padding: "12px 30px", cursor: "pointer", fontSize: "12px", fontWeight: "600", textTransform: "uppercase", letterSpacing: "1px", borderRadius: "4px" }}
            >
              Vazhdo te Pagesa
            </button>
          </div>
      ...
      {/* CHECKOUT MODAL */}
      {showCheckoutModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(17,13,26,0.7)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 99999, backdropFilter: "blur(5px)" }}>
          <div style={{ background: "#FFFFFF", padding: "35px", maxWidth: "500px", width: "90%", border: "1px solid #E6E0D8", boxShadow: "0 15px 35px rgba(0,0,0,0.3)", borderRadius: "12px" }}>
            {!orderSuccess ? (
              <>
                <h3 style={{ fontFamily: "Georgia, serif", color: "#2B1A4A", marginBottom: "5px", textAlign: "center" }}>
                  Të Dhënat e Dërgesës
                </h3>
                <p style={{ fontSize: "13px", color: "#666", textAlign: "center", marginBottom: "25px" }}>
                  Plotësoni formën për të finalizuar faturën tuaj.
                </p>
                ...
                <form onSubmit={handlePlaceOrder} style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                  <div>
                    ...
                    <input type="text" name="fullName" required value={shippingDetails.fullName} onChange={handleInputChange}
                      style={{ width: "100%", padding: "10px", border: "1px solid #CBD5E1", fontSize: "14px", borderRadius: "4px", boxSizing: "border-box" }} placeholder="Filan Fisteku" />
                  </div>

                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
                    <div>
                      <label style={{ display: "block", fontSize: "12px", fontWeight: "600", marginBottom: "5px", color: "#110D1A" }}>Qyteti *</label>
                      <select name="city" value={shippingDetails.city} onChange={handleInputChange}
                        style={{ width: "100%", padding: "10px", border: "1px solid #CBD5E1", fontSize: "14px", background: "white", borderRadius: "4px", boxSizing: "border-box" }}>
                    ...
                    <div>
                      ...
                      <input type="tel" name="phone" required value={shippingDetails.phone} onChange={handleInputChange}
                        style={{ width: "100%", padding: "10px", border: "1px solid #CBD5E1", fontSize: "14px", borderRadius: "4px", boxSizing: "border-box" }} placeholder="+383 4X XXX XXX" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input type="text" name="address" required value={shippingDetails.address} onChange={handleInputChange}
                      style={{ width: "100%", padding: "10px", border: "1px solid #CBD5E1", fontSize: "14px", borderRadius: "4px", boxSizing: "border-box" }} placeholder="Rruga, Numri i hyrjes/shtëpisë" />
                  </div>
                  ...
                  <div style={{ background: "#F8FAFC", padding: "12px", border: "1px dashed #CBD5E1", marginTop: "10px", fontSize: "14px", fontWeight: "600", color: "#0E5A5B", display: "flex", justifyContent: "space-between", borderRadius: "4px" }}>
                  ...
                  <div style={{ display: "flex", gap: "10px", marginTop: "15px" }}>
                    <button type="button" onClick={() => setShowCheckoutModal(false)}
                      style={{ flex: 1, background: "transparent", border: "1px solid #777", padding: "12px", cursor: "pointer", fontSize: "12px", textTransform: "uppercase", borderRadius: "4px" }}>
                      Anulo
                    </button>
                    <button type="submit"
                      style={{ flex: 1, background: "#2B1A4A", color: "white", border: "none", padding: "12px", cursor: "pointer", fontSize: "12px", textTransform: "uppercase", fontWeight: "600", letterSpacing: "1px", borderRadius: "4px" }}>
                      Përfundo Porosinë
                    </button>
                  </div>
                </form>
              ...
              <div style={{ padding: "30px 10px", textAlign: "center" }}>
                ...
                <h3 style={{ fontFamily: "Georgia, serif", color: "#2B1A4A", marginBottom: "10px" }}>
                  Porosia u Krye me Sukses!
                </h3>
                <p style={{ fontSize: "14px", color: "#555", lineHeight: "1.5" }}>
                  Faleminderit <strong>{shippingDetails.fullName}</strong>! Lulet tuaja do të dërgohen në{" "}
                  <strong>{shippingDetails.address}, {shippingDetails.city}</strong> brenda kohës rekord.
                </p>
...
══════════════════════════════════════════════════════════ */
const AppFooter = () => (
  <footer style={{ background: "#2B1A4A", color: "white", padding: "40px 5%", display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginTop: "40px", flexWrap: "wrap", gap: "40px" }}>
    {/* About */}
    <div style={{ flex: "1 1 360px" }}>
      <h3 style={{ color: "white", marginBottom: "15px", fontSize: "18px", fontWeight: "bold" }}>About Us</h3>
      <p style={{ fontSize: "14px", lineHeight: "1.7", marginBottom: "20px", textAlign: "justify", color: "rgba(255,255,255,0.75)" }}>
      ...
      <Link
        to="/about"
        style={{ display: "inline-block", padding: "8px 25px", background: "#0E5A5B", color: "white", textDecoration: "none", borderRadius: "5px", fontSize: "13px", fontWeight: "bold" }}
      >
        Learn More
      </Link>
    </div>
    ...
    <div style={{ flex: "1 1 360px" }}>
      ...
      <p style={{ fontSize: "14px", marginBottom: "15px", lineHeight: "1.7", color: "rgba(255,255,255,0.75)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px", fontSize: "13px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.8)" }}>@EternalRose</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <FaPhoneAlt color="#0E5A5B" />
          <span style={{ color: "rgba(255,255,255,0.8)" }}>+383 44 453 821</span>
        </div>
      </div>
    </div>
  </footer>
