...
const AppFooter = () => (
 ...
 Jemi këtu për t'ju ndihmuar me çdo pyetje apo nevojë për dekorim.
 </p>
...
function AppContent() {
 ...
 <Route path="/user/birthday" element={<Flowers />} />
 ...
 <Route path="/supply-orders" element={<PrivateRoute adminOnly><SupplyOrdersCRUD /></PrivateRoute>} />
