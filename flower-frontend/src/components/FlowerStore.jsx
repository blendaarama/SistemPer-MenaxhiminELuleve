...
const Homepage = () => {
  ...
  const inputStyle = {
    ...
    borderRadius: "8px", fontFamily: FONT, fontSize: "14px", color: C.text,
    background: C.white, outline: "none", boxSizing: "border-box", transition: "border-color 0.2s",
  };
    ...
    <>
      ...
      <div style={{ fontFamily: FONT, background: C.cream, color: C.text, minHeight: "100vh", width: "100%", overflowX: "hidden", opacity: isVisible ? 1 : 0, transition: "opacity 0.55s ease" }}>
        ...
        <nav style={{
          ...
          <div style={{ fontFamily: SERIF, fontSize: "22px", fontWeight: "700", color: C.dark, letterSpacing: "-0.3px" }}>
            You're eternal.
          </div>
          ...
          <div style={{ display: "flex", gap: "14px", alignItems: "center" }}>
            {isAdmin && (
              <Link to="/admin/dashboard" style={{ textDecoration: "none" }}>
                <button className="btn-teal" style={{ background: C.teal, color: "#fff", padding: "8px 16px", border: "none", cursor: "pointer", fontSize: "12px", fontWeight: "600", borderRadius: "6px", fontFamily: FONT }}>
                  Admin
                </button>
              </Link>
            )}
        ...
        <section style={{ display: "flex", background: C.offWht, alignItems: "stretch", minHeight: "540px", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: "1 1 420px", padding: "64px 6%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <form onSubmit={handleSearch} style={{ display: "flex", maxWidth: "400px", marginBottom: "24px", borderRadius: "8px", overflow: "hidden", boxShadow: "0 4px 20px rgba(0,0,0,0.1)" }}>
              ...
              />
              <button type="submit"
                style={{ background: C.teal, color: "#fff", border: "none", padding: "13px 20px", fontSize: "13px", fontWeight: "600", cursor: "pointer", fontFamily: FONT, whiteSpace: "nowrap" }}
                onMouseEnter={e => e.currentTarget.style.background = C.tealLt}
                onMouseLeave={e => e.currentTarget.style.background = C.teal}
              >Search</button>
            </form>
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <button className="btn-teal" onClick={() => navigate("/user/occasions")}
                style={{ background: C.teal, color: "#fff", border: "none", padding: "14px 28px", borderRadius: "8px", fontSize: "14px", fontWeight: "600", cursor: "pointer", fontFamily: FONT }}>
                Shop the Sale
              </button>
              <button className="btn-outline" onClick={() => navigate("/user/flowers")}
                style={{ background: "transparent", color: C.text, border: `1px solid ${C.border}`, padding: "14px 28px", borderRadius: "8px", fontSize: "14px", fontWeight: "500", cursor: "pointer", fontFamily: FONT }}>
          ...
          <div style={{ maxWidth: "860px", margin: "0 auto", display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap", justifyContent: "center" }}>
            ...
            <form onSubmit={handleSearch} style={{ display: "flex", gap: "10px", flex: 1, flexWrap: "wrap", justifyContent: "center" }}>
              <input
                ...
                style={{ flex: "1 1 180px", maxWidth: "240px", padding: "12px 14px", border: "1px solid rgba(255,255,255,0.2)", borderRadius: "8px", fontFamily: FONT, fontSize: "14px", color: "#fff", background: "rgba(255,255,255,0.1)", outline: "none", boxSizing: "border-box" }}
              />
              ...
              <button type="submit" className="btn-teal"
                style={{ background: C.teal, color: "#fff", border: "none", padding: "12px 24px", borderRadius: "8px", fontFamily: FONT, fontSize: "13px", fontWeight: "600", cursor: "pointer", whiteSpace: "nowrap" }}>
                Search gifts
              </button>
            </form>
          </div>
              ...
              {categories.map(cat => (
                <Link key={cat.name} to={`/user/${cat.name.toLowerCase()}`} style={{ textDecoration: "none" }}>
                  <div className="cat-item" style={{ flex: "0 0 120px", textAlign: "center" }}>
                    ...
                    <div className="cat-label" style={{ fontFamily: FONT, fontSize: "13px", fontWeight: "600", color: C.text }}>{cat.name}</div>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            {loading ? (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "20px", marginBottom: "40px" }}>
                {flowers.slice(0, 8).map(item => (
                  <div key={item.id} className="product-card" style={{ background: C.white, border: `1px solid ${C.border}`, borderRadius: "12px", padding: "16px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
                    <img
                      src={item.foto}
                      alt={item.emertimi}
                    ...
                    />
                    <h4 style={{ fontFamily: SERIF, fontSize: "16px", marginBottom: "4px", color: C.dark }}>{item.emertimi}</h4>
                    <p style={{ fontFamily: FONT, fontSize: "13px", color: C.teal, fontWeight: "600" }}>${item.cmimi}</p>
                  </div>
                ))}
              </div>
            )}
            ...
            <div style={{ textAlign: "center", marginTop: "20px" }}>
              ...
              <button
                ...
                style={{ background: C.teal, color: "#fff", border: "none", padding: "14px 26px", borderRadius: "10px", fontSize: "14px", fontWeight: "600", cursor: "pointer", fontFamily: FONT }}>
        ...
        <section style={{ padding: "80px 6%", background: C.white }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            <div style={{ textAlign: "center", marginTop: "40px" }}>
              <button className="btn-teal" onClick={() => setShowReviewModal(true)}
                style={{ background: C.teal, color: "#fff", border: "none", padding: "13px 28px", borderRadius: "8px", fontSize: "14px", fontWeight: "600", cursor: "pointer", fontFamily: FONT }}>
                Write a review
              </button>
            </div>
          </div>
        ...
        {showBackToTop && (
          <button className="back-to-top" onClick={scrollToTop}
            style={{ position: "fixed", bottom: "28px", right: "28px", width: "46px", height: "46px", borderRadius: "50%", background: C.teal, color: "#fff", border: "none", cursor: "pointer", fontSize: "18px", boxShadow: "0 4px 20px rgba(0,0,0,0.22)", zIndex: 9998, display: "flex", alignItems: "center", justifyContent: "center", animation: "popIn 0.25s ease" }}>
            ↑
          </button>
        )}
          ...
          <div style={{ position: "fixed", inset: 0, background: "rgba(15,10,30,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999, padding: "20px" }}>
            <div style={{ background: C.white, padding: "36px", width: "100%", maxWidth: "420px", borderRadius: "16px", boxShadow: "0 32px 80px rgba(0,0,0,0.28)", animation: "popIn 0.25s ease" }}>
              ...
              <p style={{ fontFamily: FONT, fontSize: "14px", color: C.muted, marginBottom: "28px" }}>
                How many of <strong style={{ color: C.dark }}>{selectedProduct.emertimi}</strong> would you like?
              </p>
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "24px", marginBottom: "16px" }}>
                <button className="btn-outline" onClick={() => setQuantity(q => Math.max(1, q - 1))} style={{ width: "44px", height: "44px", border: `1px solid ${C.border}`, borderRadius: "8px", cursor: "pointer", fontSize: "20px", background: C.cream, fontFamily: FONT }}>−</button>
                <span style={{ fontSize: "36px", fontWeight: "700", color: C.dark, fontFamily: SERIF, minWidth: "48px", textAlign: "center" }}>{quantity}</span>
                <button className="btn-outline" onClick={() => setQuantity(q => q + 1)} style={{ width: "44px", height: "44px", border: `1px solid ${C.border}`, borderRadius: "8px", cursor: "pointer", fontSize: "20px", background: C.cream, fontFamily: FONT }}>+</button>
              </div>
              <div style={{ textAlign: "center", marginBottom: "26px", padding: "14px", background: C.cream, borderRadius: "8px", border: `1px solid ${C.border}` }}>
                ...
                <span style={{ fontFamily: SERIF, fontSize: "22px", fontWeight: "700", color: C.teal }}>${(selectedProduct.cmimi * quantity).toFixed(2)}</span>
              </div>
              <div style={{ display: "flex", gap: "10px" }}>
                <button className="btn-outline" onClick={() => setShowPopup(false)} style={{ flex: 1, padding: "13px", border: `1px solid ${C.border}`, background: "transparent", cursor: "pointer", borderRadius: "8px", fontFamily: FONT, fontSize: "14px" }}>Cancel</button>
                <button className="btn-dark" onClick={handleConfirmAdd} style={{ flex: 1, padding: "13px", background: C.dark, color: "#fff", border: "none", cursor: "pointer", borderRadius: "8px", fontWeight: "600", fontFamily: FONT, fontSize: "14px" }}>Add to cart</button>
              </div>
            </div>
          </div>
        )}
        ...
        {showReviewModal && (
          <div style={{ position: "fixed", inset: 0, background: "rgba(15,10,30,0.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999, padding: "20px" }}>
            <div style={{ background: C.white, padding: "36px", width: "100%", maxWidth: "420px", borderRadius: "16px", boxShadow: "0 32px 80px rgba(0,0,0,0.28)", animation: "popIn 0.25s ease" }}>
              ...
              <p style={{ fontFamily: FONT, fontSize: "13px", color: C.muted, marginBottom: "24px" }}>Share your experience — your feedback helps thousands of customers.</p>
              ...
              <input placeholder="e.g. Sarah M." value={newReview.customerName}
              ...
              <textarea placeholder="What did you love about your order?" value={newReview.comment}
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                <button className="btn-outline"
                  ...
                  style={{ flex: 1, padding: "13px", border: `1px solid ${C.border}`, background: "transparent", cursor: "pointer", borderRadius: "8px", fontFamily: FONT, fontSize: "14px" }}>
                  Cancel
                </button>
                <button className="btn-teal" onClick={handleSubmitReview}
                  style={{ flex: 1, padding: "13px", background: C.teal, color: "#fff", border: "none", cursor: "pointer", borderRadius: "8px", fontWeight: "600", fontFamily: FONT, fontSize: "14px" }}>
                  Submit review
                </button>
              </div>
            </div>
