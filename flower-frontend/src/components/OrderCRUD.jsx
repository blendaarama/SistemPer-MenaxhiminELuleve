...
// ✅ Endpoint-i i saktë sipas backend-it
...
const OrderCRUD = () => {
  ...
  const S = {
    ...
    error:  { background: "#FFEAEA", color: "#C0392B", border: "1px solid #FFD1D1", borderRadius: "8px", padding: "12px 16px", marginBottom: "20px", fontSize: "13px" },
    refreshBtn: { background: "none", border: "1px solid #0E5A5B", color: "#0E5A5B", padding: "8px 16px", cursor: "pointer", borderRadius: "4px", fontSize: "13px", fontFamily: "inherit" },
    table:  { width: "100%", background: "#FFF", borderCollapse: "collapse", border: "1px solid #E6E0D8", borderRadius: "6px", overflow: "hidden" },
    ...
    delBtn: { background: "transparent", color: "#C0392B", border: "1px solid #C0392B", borderRadius: "4px", fontSize: "11px", letterSpacing: "0.8px", textTransform: "uppercase", padding: "5px 12px", fontWeight: "600", cursor: "pointer", fontFamily: "inherit" },
    select: { border: "1px solid #D0C8C0", borderRadius: "6px", padding: "6px 10px", fontSize: "13px", background: "#FAFAFA", cursor: "pointer", fontFamily: "inherit" },
                  ...
                  return (
                    <tr key={order.id} style={{ background: i % 2 === 0 ? "#FFF" : "#FDFAF7" }}>
                      ...
                      <td style={{ ...S.td, color: "#777", whiteSpace: "nowrap" }}>
                        {order.dataPorosise
                          ? new Date(order.dataPorosise).toLocaleDateString("sq-AL")
                          : "—"}
                      </td>
                      ...
                      <td style={{ ...S.td, fontWeight: "700", fontFamily: "Georgia, serif" }}>
                        {(order.shumeTotale || 0).toFixed(2)} €
                      </td>
                      <td style={S.td}>
                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                          <span style={{ ...sStyle, fontSize: "11px", fontWeight: "700", padding: "4px 10px", borderRadius: "4px", letterSpacing: "0.5px", textTransform: "uppercase", whiteSpace: "nowrap" }}>
                            {status}
                          </span>
                          <select
                            value={status}
